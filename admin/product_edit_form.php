                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="hidden" name="prd_id" class="form-control" value="<?php echo $product['prd_id']; ?>">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="prd_isbn" class="form-control" placeholder="ระบุ รหัส ISBN สินค้า" maxlength="100" value="<?php echo $product['prd_isbn']; ?>">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <label for="prd_number_pages" class="form-label">จำนวนหน้า :</label><span class="text-danger">*</span>
                                            <input type="number" name="prd_number_pages" class="form-control" placeholder="ระบุ จำนวนสินค้า" value="<?php echo $product['prd_number_pages']; ?>">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <label for="prd_price" class="form-label">ส่วนลด :</label><span class="text-danger">*</span>
                                            <div class="input-group">
                                                <input type="number" name="prd_price" class="form-control" placeholder="ระบุ ราคาสินค้า" value="<?php echo $product['prd_percent_discount']; ?>">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="pty_id">
                                                <option value="" <?php if (empty($productType) || empty($product['pty_id'])) {
                                                                        echo 'selected';
                                                                    } ?>>กรุณาระบุ ประเภทสินค้า</option>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="pub_id">
                                                <option value="" <?php if (empty($publisher) || empty($product['pub_id'])) {
                                                                        echo 'selected';
                                                                    } ?>>กรุณาระบุ สำนักพิมพ์</option>

                                                <?php foreach ($publisher as $row) { ?>
                                                    <option value="<?php echo $row['pub_id'] ?>" <?php if ($row['pub_id'] == $product['pub_id']) {
                                                                                                        echo 'selected';
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="auth_id">
                                                <option value="" <?php if (empty($author) || empty($product['auth_id'])) {
                                                                        echo 'selected';
                                                                    } ?>>กรุณาระบุ ชื่อผู้แต่ง</option>

                                                <?php foreach ($author as $row) { ?>
                                                    <option value="<?php echo $row['auth_id'] ?>" <?php if ($row['auth_id'] == $product['auth_id']) {
                                                                                                        echo 'selected';
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check mb-2 form-check-primary">
                                                <input class="form-check-input" type="radio" name="prd_preorder" id="1" value="1" <?php if($product['prd_preorder'] == 1){ echo 'checked';} ?>>
                                                <label class="form-check-label" for="1">สินค้าปกติ</label>
                                            </div>
                                            <div class="form-check mb-2 form-check-warning">
                                                <input class="form-check-input" type="radio" name="prd_preorder" id="0" value="0" <?php if($product['prd_preorder'] != 1){ echo 'checked';} ?>>
