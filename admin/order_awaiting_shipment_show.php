<?php
$titlePage = "รายการสั่งซื้อที่รอจัดส่ง";
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="mt-0 header-title">ข้อมูลรายการสั่งซื้อที่รอจัดส่ง</h4>
                                    <hr>
                                                ...
                                                <?php foreach ($orderStatusUnderReview as $row) { ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <?php if ($row['ord_status'] == "Awaiting Shipment") { ?>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="order_awaiting_shipment_detail?id=<?php echo $base64Encoded ?>" class="btn btn-info">
