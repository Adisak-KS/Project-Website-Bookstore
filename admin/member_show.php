                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="mt-0 header-title">ข้อมูลสมาชิกทั้งหมด</h4>
                                    <div class="my-3">
                                                ...
                                                <?php foreach ($members as $row) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="member_edit_form?id=<?php echo $base64Encoded ?>" class="btn btn-warning">
                                                                <i class="fa-solid fa-pen-to-square me-1"></i>
                                                                <span>แก้ไข</span>
                                                            </a>

                                                            <a href="member_del_form?id=<?php echo $base64Encoded ?>" class="btn btn-danger ms-2">
