...
if (isset($_GET['id'])) {
    ...
    $order = $OrderController->getOrderDetailStatusUnderReview($ordId);
...
<body class="loading" data-layout-color="light" data-layout-mode="default" data-layout-size="fluid" data-topbar-color="light" data-leftbar-position="fixed" data-leftbar-color="light" data-leftbar-size='default' data-sidebar-user='true'>
    ...
    <div id="wrapper">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div>
                                        <a href="order_show" class="btn btn-secondary me-2">
                                        ...
                                        <button type="submit" name="btn-order-confirm" class="btn btn-success me-2 btn-order-confirm" data-ord_id="<?php echo $order['ord_id'] ?>">
                                            <i class="fa-solid fa-check"></i>
                                            <span>ยืนยันชำระเงินถูกต้อง</span>
                                        </button>
                                    </div>
        ...
        <script>
            ...
            function OrderConfirm(ordId) {
                Swal.fire({
                    icon: "warning",
                    title: 'ชำระเงินถูกต้อง?',
                    text: "รายการสั่งซื้อนี้ ชำระเงินถูกต้อง!",
                    showCancelButton: true,
                    confirmButtonColor: '#f34e4e',
                    confirmButtonText: 'ใช่, ยืนยันชำระเงินถูกต้อง!',
                    cancelButtonText: 'ยกเลิก',
                    preConfirm: function() {
                        return $.ajax({
                                url: 'process/order_detail_confirm.php',
                                type: 'POST',
                                data: {
                                    ord_id: ordId,
                                },
