...
if (isset($_POST['btn-add'])) {
    ...
    echo "prp_prd_name = " . $prpPrdName . "<br>";
    echo "prp Publisher = " . $prpPublisher . "<br>";
    echo "prp Author = " . $prpAuthor . "<br>";
    echo "prp Prd Volume Number = " .  $prpPrdVolumeNumber . "<br>";
    echo "prp Detail = " . $prpDetail . "<br>";
    echo "prp img = " . $prpImg . "<br>";
