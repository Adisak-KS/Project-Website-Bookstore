...
if (isset($_GET['search']) && $_GET['search'] !== '') {
    ...
    $searchResult = $ProductController->getSearchResult($search);


}else{
    header("Location: products_show");
    exit;
}
...
//     $searachResult = $ProductController->getProductsAllFocusType($ptyId);
// } elseif (isset($_GET['pubId'])) {
//     $base64Encoded = $_GET['pubId'];
//     $pubId = decodeBase64ID($base64Encoded, $salt1, $salt2);
//     $searchResult = $ProductController->getProductsAllFocusPublisher($pubId,);
// } elseif (isset($_GET['authId'])) {
//     $base64Encoded = $_GET['authId'];
//     $authId = decodeBase64ID($base64Encoded, $salt1, $salt2);
//     $searchResult = $ProductController->getProductsAllFocusAuthor($authId);
// } else {
//     $searchResult = $ProductController->getProductsAllPromotions($prdPercentDiscount);
// }
?>
                ...
                <div class="col-lg-12">
                    <div class="breadcrumbs-menu">
                        <ul>
                            ...
                            <li><a href="javascript:void(0)" class="active">ผลการค้นหา</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                        <div class="alert alert-secondary text-center" role="alert">
                                            ...
                                            <div class="">
                                                ...
                                                <a href="products_promotions" class="ms-5">ผลการค้นหา</a>
                                            </div>
                                        </div>
                                    </div>
                                <?php } ?>
