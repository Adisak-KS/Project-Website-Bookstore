                            ...
                            <div class="left-menu mb-30">
                                <ul>
                                    <?php foreach ($productsPreOrderType10 as $row) { ?>
                                        ...
                                        ?>
                                        <li>
                                            <a href="products_preorder_show?ptyId=<?php echo $base64Encoded ?>">
                                                <?php
                            ...
                            <div class="left-menu mb-30">
                                <ul>
                                    <?php foreach ($publishersPreOrder10 as $row) { ?>
                                        ...
                                        ?>
                                        <li>
                                            <a href="products_preorder_show?pubId=<?php echo $base64Encoded ?>">
                                                <?php
                            ...
                            <div class="left-menu mb-30">
                                <ul>
                                    <?php foreach ($authorsPreOrder10 as $row) { ?>
                                        ...
                                        ?>
                                        <li>
                                            <a href="products_preorder_show?authId=<?php echo $base64Encoded ?>">
                                                <?php
